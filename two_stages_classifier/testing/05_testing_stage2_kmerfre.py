...
path = "../../GutEuk/model/stage2-kmerfre.pth"
...
with torch.inference_mode():
    for index in tqdm(range(40), desc = "Batchs (validation) finished", miniters=4):
        prediction = []
        test = utils.mydataset_m2("/fs/scratch/PAS0439/Ming/databases/gut_eukaryotes_classifier/stage2/transformed_dataset/test", str(index).zfill(3), 1)   
        ...
        np.savez(f"/fs/ess/PAS0439/MING/cilates_fungi_classifier/outputs/GutEuk_classifier/stage2/testing/pred_kmerfre_{str(index).zfill(3)}.npz" , *prediction)
