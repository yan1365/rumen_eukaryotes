...
path = "../../GutEuk/model/stage2-cnn.pth"
...
with torch.inference_mode():
    for index in tqdm(range(40), desc = "Batchs (validation) finished", miniters=4):
        ...
        np.savez(f"/fs/ess/PAS0439/MING/cilates_fungi_classifier/outputs/GutEuk_classifier/stage2/testing/pred_cnn_{str(index).zfill(3)}.npz" , *prediction)
