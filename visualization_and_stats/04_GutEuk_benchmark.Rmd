...
pre_recall_by_len_merged %>% filter(category %in% c("prokaryotes", "eukaryotes")) %>% ggplot(aes(x = sequence_length, y = recall, col = tool)) + geom_point() + geom_line() + facet_wrap(vars(category),dir = "v", ncol = 1) + 
  theme_minimal() +
  labs(x = "", y = "Recall") +
  theme(text = element_text(size=6)) +
  theme(axis.text.x = element_blank())+
  theme(legend.position = "none", legend.title = element_blank())
ggsave("/fs/ess/PAS0439/MING/cilates_fungi_classifier/stats_visualization/recall_contigs_by_len_stage1.svg", width = 5, height = 1.5, units = "in")
...
ggsave("/fs/ess/PAS0439/MING/cilates_fungi_classifier/stats_visualization/precision_contigs_by_len_stage1.svg", width = 5, height = 1.5, units = "in")
...
pre_recall_by_len_merged %>% filter(!category %in% c("prokaryotes", "eukaryotes")) %>% ggplot(aes(x = sequence_length, y = recall)) + geom_point() + geom_line() + facet_wrap(vars(category),dir = "v", ncol = 1) + 
  theme_minimal() +
  labs(x = "", y = "Recall") +
  theme(text = element_text(size=6)) +
  theme(axis.text.x = element_blank())
...
ggsave("/fs/ess/PAS0439/MING/cilates_fungi_classifier/stats_visualization/recall_contigs_by_len_stage2.svg", width = 5, height = 1.5, units = "in")
...
pre_recall_by_len_merged %>% filter(!category %in% c("prokaryotes", "eukaryotes")) %>% ggplot(aes(x = sequence_length, y = precision)) + geom_point() + geom_line() + facet_wrap(vars(category),dir = "v", ncol = 1) + 
  theme_minimal() +
  labs(x = "", y = "Precision") +
  theme(text = element_text(size=6)) +
  theme(axis.text.x = element_blank())
  
ggsave("/fs/ess/PAS0439/MING/cilates_fungi_classifier/stats_visualization/precision_contigs_by_len_stage2.svg", width = 5, height = 1.5, units = "in")
